...
public interface UserMapper {
	...
	public List<UserBean> getUserListByCondition(Map<String, Object> param);

	public List<UserBean> getUserListByChooseWhen(UserBean userBeanAsCondition);

	public void updateUserNameAndPwdByCondition(Map<String, Object> param);
